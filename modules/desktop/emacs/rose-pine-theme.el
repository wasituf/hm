...
(autothemer-deftheme
 ...
 ;; Customize faces
 (access-selection   (:foreground gold))
...
;;; rose-pine-theme.el ends here
  ...
  (line-number                          (:inherit 'default :foreground highlight-high))
  (line-number-current-line             (:inherit 'default :background overlay :foreground iris :bold t))
